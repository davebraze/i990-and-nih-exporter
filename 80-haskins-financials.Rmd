...
pi.activity.cap <- "Years in which each primary investigator has grant income. PIs are sorted by final year of activity within depicted span. This chart indicates grant activity at Haskins only. A PI's grant activity at other organizations is not included here. Co-PIs are shown as composite individuals. Note years in which a PI has grant income only through unfunded extensions are not included."
